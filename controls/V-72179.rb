...
ssh commands. The organization must maintain audit trails in sufficient detail to
...
-a always,exit -F path=/usr/libexec/openssh/ssh-keysign -F perm=x -F auid>=1000 -F
