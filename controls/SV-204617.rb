control 'SV-204617' do
  ...
  tag 'rationale': ''
  tag 'check': %q(Verify the system does not send IPv4 ICMP redirect messages.
  ...
  tag 'fix': 'Configure the system to not allow interfaces to perform IPv4 ICMP redirects.
