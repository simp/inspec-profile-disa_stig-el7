control 'SV-204488' do
  ...
  tag 'rationale': ''
  tag 'check': 'Verify that the default umask for all local interactive users is "077".
  ...
  tag 'fix': %q(Remove the umask statement from all local interactive user's initialization files.
