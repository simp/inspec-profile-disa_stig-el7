control 'SV-204616' do
  ...
  tag 'rationale': ''
  tag 'check': %q(Verify the system does not allow interfaces to perform IPv4 ICMP redirects by default.
  ...
  tag 'fix': 'Configure the system to not allow interfaces to perform IPv4 ICMP redirects by default.
