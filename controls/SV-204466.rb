control 'SV-204466' do
  ...
  tag 'rationale': ''
  tag 'check': 'Verify all local interactive users on the system are assigned a home directory upon creation.
    ...
    this is a finding.'
  tag 'fix': 'Configure the operating system to assign home directories to all new local interactive users by
