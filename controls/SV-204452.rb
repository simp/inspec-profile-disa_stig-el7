control 'SV-204452' do
  ...
  tag 'rationale': ''
  tag 'check': 'Verify the operating system removes all software components after updated versions have been
    installed.
    ...
    finding.'
  tag 'fix': 'Configure the operating system to remove all software components after updated versions have been
    installed.
